        ...
        <s.HeadContainer>
          ...
          <s.CenterHead>
            <s.MockSearchBtn>
              <s.BtnWrapper>
                <s.SearchBtn>
                  <s.SearchBtnLabel>Bắt đầu tìm kiếm</s.SearchBtnLabel>
                  <s.SearchIcon>
                    <svg
                      viewBox="0 0 32 32"
                ...
                <s.Form>
                  <s.Fieldset>
                    <s.Sections>
                      ...
                      <s.SectionsLink>
                        <Link href="/s/experiences/online">
                        ...
                        <s.FieldWrapperOne>
                          <s.FieldOneLabel>
                            <s.LabelContain>
                              ...
                              <s.SearchPlaceInput placeholder="Bạn sắp đi đâu?" />
                            </s.LabelContain>
                          </s.FieldOneLabel>
                          {/* clear button appears when use have typed in the input field */}
                          <s.ClearBtn>
                            <s.ClearBtnWrapper>
                              <s.XButton>
                                <span>
                          ...
                          <s.FieldOneSpans>
                            Điều hướng về phía trước để truy cập kết quả được đề
                            xuất
                          </s.FieldOneSpans>
                        ...
                        <s.SearchSubmitBtn>
                          <s.SubmitBtn>
                            <s.SubmitBtnContent>
                              ...
                              <s.SearchBtnTitle>Tìm kiếm</s.SearchBtnTitle>
                            </s.SubmitBtnContent>
                          </s.SubmitBtn>
                        </s.SearchSubmitBtn>
                      </s.FieldThree>
